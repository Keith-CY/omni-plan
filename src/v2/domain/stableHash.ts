...
/**
 * Browser-safe synchronous SHA-256 for policy selectors that must return a
 * fail-closed answer in the same render/scheduling turn. The async Web Crypto
 * implementation remains the source used when creating signed records.
 */
...
export function stableHashSync(value: JsonValue): string {
